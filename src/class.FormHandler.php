...
class FormHandler
{
     ...
     * @author Teye Heimans
     */
	public function addValue($field, $value, $sqlFunction = false)
	{
     ...
     * @author Teye Heimans
     */
	protected function _getNewButtonName()
	{
		static $counter = 1;
     ...
     * @author Teye Heimans
     */
	protected function _setJS( $js, $isFile = false, $before = true)
	{
     ...
     * @author Teye Heimans
     */
	protected function _registerFileName( $sFilename, $sField )
	{
